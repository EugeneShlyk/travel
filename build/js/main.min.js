...
var _addAudioSrc = require("./modules/add-audio-src.js");
var _addVideoSrc = require("./modules/add-video-src.js");
var _advantagesSlider = require("./modules/advantages-slider.js");
var _commentsSlider = require("./modules/comments-slider.js");
var _gallerySlider = require("./modules/gallery-slider.js");
var _heroSlider = require("./modules/hero-slider.js");
var _instructorsSlider = require("./modules/instructors-slider.js");
var _posterVideo = require("./modules/poster-video.js");
var _toursSlider = require("./modules/tours-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _instructorsSlider.initInstructorsSlider)();
    (0, _commentsSlider.initCommentsSlider)();
    (0, _advantagesSlider.initAdvantagesSlider)();
    (0, _gallerySlider.initGallerySlider)();
    (0, _addAudioSrc.addAudioSrc)();
    (0, _addVideoSrc.addVideoSrc)();
  });
});
...
},{"./modules/add-audio-src.js":2,"./modules/add-video-src.js":3,"./modules/advantages-slider.js":4,"./modules/comments-slider.js":5,"./modules/form-validate/form":7,"./modules/gallery-slider.js":13,"./modules/hero-slider.js":14,"./modules/instructors-slider.js":15,"./modules/modals/init-modals":16,"./modules/navigation.js":18,"./modules/poster-video.js":19,"./modules/tours-slider.js":20,"./modules/video.js":21,"./utils/ios-vh-fix":24}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addAudioSrc = void 0;
var slides = document.querySelectorAll('.hero-card');
var pagination = document.querySelector('.hero__box-button');
var audio = document.querySelector('.hero-card__inner-container-audio');
var addAudioSrc = function addAudioSrc() {
  pagination.addEventListener('click', function () {
    slides.forEach(function (slide) {
      if (slide.querySelector('.hero-card__inner-container-audio') && slide.classList.contains('swiper-slide-active')) {
...
exports.addAudioSrc = addAudioSrc;
...
exports.addVideoSrc = void 0;
var slides = document.querySelectorAll('.hero-card');
var pagination = document.querySelector('.hero__box-button');
var video = document.querySelector('.hero-card__video');
var addVideoSrc = function addVideoSrc() {
  pagination.addEventListener('click', function () {
    slides.forEach(function (slide) {
      if (slide.querySelector('.hero-card__video') && slide.classList.contains('swiper-slide-active')) {} else {
        video.pause();
      }
    });
  });
};
exports.addVideoSrc = addVideoSrc;
...
var slider = document.querySelector('.advantages__slider-wrapper');
var initAdvantagesSlider = function initAdvantagesSlider() {
  return window.matchMedia('(min-width: 1200px)').matches && slider && new Swiper('.advantages__slider-wrapper', {
    navigation: {
...
var Swiper = window.Swiper;
var slider = document.querySelector('.gallery__slider-wrapper');
var initGallerySlider = function initGallerySlider() {
  return slider && new Swiper('.gallery__slider-wrapper', {
    navigation: {
...
exports.workHeroSlider = void 0;
var Swiper = window.Swiper;
var slider = document.querySelector('.hero__slider');
var workHeroSlider = function workHeroSlider() {
...
exports.workHeroSlider = workHeroSlider;
...
var Swiper = window.Swiper;
var slider = document.querySelector('.instructors__slider');
var initInstructorsSlider = function initInstructorsSlider() {
  return slider && new Swiper('.instructors__slider', {
    navigation: {
...
},{"../../utils/focus-lock":22,"../../utils/scroll-lock":25}],18:[function(require,module,exports){
"use strict";
...
var navigationToggle = document.querySelector('.header__button-menu');
var body = document.querySelector('body');
var modal = document.querySelector('.navigation__list');
var menuLinks = document.querySelectorAll('.navigation__list-item-link');
var logoWrapper = document.querySelector('.header__logo-image-wrapper');
...
var Swiper = window.Swiper;
var slider = document.querySelector('.tours__slider');
var initToursSlider = function initToursSlider() {
  return slider && new Swiper('.tours__slider', {
    navigation: {
...
var video = document.querySelector('.hero-card__video');
var button = document.querySelector('.hero-card__video-button');
